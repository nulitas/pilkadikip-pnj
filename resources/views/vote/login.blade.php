                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                            ...
                            <g style="stroke: none; stroke-width: 0; stroke-dasharray: none; stroke-linecap: butt; stroke-linejoin: miter; stroke-miterlimit: 10; fill: none; fill-rule: nonzero; opacity: 1;"
                                ...
                                <path
                                    ...
                                    style="stroke: none; stroke-width: 1; stroke-dasharray: none; stroke-linecap: butt; stroke-linejoin: miter; stroke-miterlimit: 10; fill: #ff4689; fill-rule: nonzero; opacity: 1;"
    ...
    <script>
        function togglePassword() {
            ...
            if (passwordField.type === 'password') {
                ...
                eyeIcon.setAttribute('fill', '#383838'); // Optional: change icon color when showing password
            } else {
                passwordField.type = 'password';
                eyeIcon.setAttribute('fill', 'currentColor'); // Optional: revert icon color when hiding password
            }
        }
    </script>
</body>
